...
void test_padding_functions(bit_c_t random_bit_position,pcg32_random_t* rng) {
	...
	for(bit_c_t i = 1; i < BUFFER_SIZE_BITS; i++) {
...
int main() {
    ...
    for (int i = 0; i < TEST_SIZE; i++) {
        ...
        test_padding_functions(random_bit_position,&rng);
    }
